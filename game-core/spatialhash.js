...
class SpatialHash {
  /**
   * Create a SpatialHash
   *
   * @param {number} size - The size of each grid cell in the spatial hash.
   * @param {boolean} isStrong - If a Map should be used internally instead of a WeakMap.
   */
   ...
   * @returns {array} Two-element array of [x, y]
   */
  cellCoord (x, y) {
    return [
   ...
   *
   * @param {object} object - The JavaScript object to add.
   * @param {number} x - The x coordinate.
   * @param {number} y - The y coordinate.
   ...
   *
   * @param {object} object - The JavaScript object to remove.
   */
  remove (object) {
   ...
   *
   * @param {object} object - The JavaScript object to get hitbox of.
   ...
   * The x, y coordinate pair represent the top-left corner of the bounding box.
   *
   * @param {object} object - The JavaScript object to update.
   * @param {number} x - The x coordinate.
   * @param {number} y - The y coordinate.
   * @param {number} width - The width of the bounding box.
   * @param {number} height - The height of the bounding box.
   ...
   * @param {number} width - The width of the bounding box.
   * @param {number} height - The height of the bounding box.
   * @returns {array} Array of objects that were in the bounding box.
   */
